...
summary(mpg_automatic); summary(mpg_manual)
...
The difference of average MPG between automatic and manaul transmission: **`rround(mean(mpg_manual),2) -round(mean(mpg_automatic),2)`** 
